...
export const gamePanel =
  "relative overflow-hidden rounded-sm border-2 border-[var(--game-cyan-dim)] bg-[var(--game-bg-elevated)] shadow-[0_0_40px_rgba(129,140,248,0.07),inset_0_1px_0_rgba(255,255,255,0.04)] backdrop-blur-md"
...
export const gameInput =
  "w-full rounded-sm border border-[var(--game-cyan-dim)] bg-[rgba(4,2,12,0.9)] px-3 py-2.5 text-sm text-[var(--game-text)] shadow-[inset_0_2px_8px_rgba(0,0,0,0.5)] outline-none transition focus:border-[var(--game-cyan)] focus:shadow-[0_0_18px_rgba(129,140,248,0.22)]"

/** CTA principaux : or / jaune (Create arena, Enter the arena, Mark ready, etc.). */
export const gameBtnPrimary =
  "inline-flex w-full items-center justify-center rounded-sm border-2 border-[var(--game-magenta)] bg-[linear-gradient(180deg,rgba(251,191,36,0.28),rgba(28,22,8,0.96))] px-4 py-2.5 text-sm font-bold uppercase tracking-[0.12em] text-[var(--game-amber)] shadow-[0_0_28px_rgba(251,191,36,0.38),inset_0_1px_0_rgba(255,255,255,0.06)] transition enabled:hover:brightness-110 enabled:active:scale-[0.99] disabled:cursor-not-allowed disabled:opacity-40"

/** Action secondaire (ex. fermer le graphique) — indigo, distinct du CTA or. */
export const gameBtnDanger =
  "inline-flex w-full items-center justify-center rounded-sm border-2 border-[var(--game-cyan)] bg-[linear-gradient(180deg,rgba(129,140,248,0.2),rgba(20,8,40,0.95))] px-4 py-2.5 text-sm font-bold uppercase tracking-[0.12em] text-[var(--game-cyan)] shadow-[0_0_22px_rgba(129,140,248,0.22)] transition enabled:hover:brightness-110 disabled:opacity-40"
...
export const gameTitle =
  "font-[family-name:var(--font-orbitron)] text-2xl font-bold uppercase tracking-wide text-[var(--game-text)] [text-shadow:0_0_24px_rgba(129,140,248,0.35)] sm:text-3xl"
...
export const gameLink =
  "text-sm font-semibold text-[var(--game-cyan)] underline decoration-[var(--game-cyan-dim)] underline-offset-4 transition hover:decoration-[var(--game-cyan)] hover:[text-shadow:0_0_12px_rgba(129,140,248,0.5)]"
...
export function gameTabActive(active: boolean) {
  return active
    ? "bg-[linear-gradient(180deg,rgba(129,140,248,0.2),rgba(129,140,248,0.06))] text-[var(--game-cyan)] shadow-[inset_0_0_12px_rgba(129,140,248,0.12)]"
...
export function GameVsBanner({
  ...
  return (
    <div className="relative overflow-hidden rounded-sm border-2 border-[var(--game-cyan-dim)] bg-[linear-gradient(90deg,rgba(251,191,36,0.12),transparent_45%,transparent_55%,rgba(129,140,248,0.12))] px-3 py-4 sm:px-5 sm:py-5">
      <div className="pointer-events-none absolute inset-0 bg-[repeating-linear-gradient(-60deg,transparent,transparent_8px,rgba(129,140,248,0.03)_8px,rgba(129,140,248,0.03)_9px)]" />
